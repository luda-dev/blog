...
## 目的
本模式用于定义 AI 的基础行为规范，适用于 Next.js、lucide、shadcn、TailWindCss、Pnpm、TypeScript、JavaScript等前端开发场景。

## AI 行为要求
- 响应风格：直接、简洁、目标导向、中文沟通。
